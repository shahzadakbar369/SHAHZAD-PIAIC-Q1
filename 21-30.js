...
//console.log(earBuds)
function displayEarbuds(earBuds) {
...
console.log("Task 22 /n");
//Intentional Error: If you haven’t received an array index error in one of your programs yet, try to make one happen. Change an index in one of your programs to produce an index error. Make sure you correct the error before closing the program.
function creatingDSLR(name, maker, model) {
    return {
        name: name,
        maker: maker,
        model: model
...
console.log(age < 18 && age == 18);
let names = ["Ali", "Aslam", "Ahmed", "Shabbir", "Ehsaan"];
...
const favoriteFruits = ["bananas", "strawberries", "apples"];
...
const usernames = ["admin", "Eric", "Alice", "John", "Sara"];
