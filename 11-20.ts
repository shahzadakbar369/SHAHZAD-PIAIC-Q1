...
let friendName: Array<string> = ['Taha', 'Wijdan', 'Ali', 'Shoaib'];
...
let favoriteTransportation : any[] = [];
...
favoriteTransportation.forEach(([vehicle, maker]) : void => 
{
...
let guestList1 : string[] = ['Taha', 'Wijdan', 'Ali', 'Shoaib']

guestList1.forEach((guestList1): void =>{
...
let guestList2 :string[] = ['Taha', 'Wijdan', 'Ali', 'Shoaib',]

let cantMake :string = 'Shoaib'
console.log(cantMake + " can’t make the dinner")

let newGuest :string = 'Abdullah'
let indexofcantMake :number = guestList2.indexOf(cantMake)
...
guestList2.forEach((guestList2) :void =>{
...
let guestList3 :string[] = ['Wijdan', 'Ali', 'Shoaib',]
...
guestList3.forEach((guestList3) :void =>{
...
let likeToVisit:string[] = ["Saudia", "UAE", "Thailand", "Missisipi", "London", "Turkey"]
...
let countries :string[] = ["Saudia", "UAE", "Thailand", "Missisipi", "London", "Turkey"]
