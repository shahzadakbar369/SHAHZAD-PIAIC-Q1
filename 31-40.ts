...
let usernames: string[] = ["admin", "Eric", "Alice", "John", "Sara"];
...
let current_users: string[] = ["Taha", "Wijdan", "Ali", "Amina", "Minahil"];
let new_users: string[] = ["Taha", "Haseeb", "Ali", "Saleem", "Ahmad"];
...
let sameAnimal: string[] = ["Goat" , "Sheep" , "Lamb"]
...
const album1: Album = makeAlbum("Artist1", "Album Title 1");
const album2: Album = makeAlbum("Artist2", "Album Title 2", 12);
const album3: Album = makeAlbum("Artist3", "Album Title 3");
